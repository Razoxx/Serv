...
public final class GuardManager {
    ...
    public static void sendToClient(GameClient client) {
    }

    public static void scheduleSendPacketToClient(long time, final GameClient client) {
    }
