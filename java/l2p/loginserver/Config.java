...
public class Config {
    ...
    public static int LOGIN_FAIL_COUNT;
    public static long LOGIN_FAIL_TIME;
    public static int LOGIN_FAIL_BURST;
    ...
    public final static void loadConfiguration() {
        ...
        LOGIN_FAIL_COUNT = serverSettings.getProperty("LoginFailCount", 5);
        LOGIN_FAIL_TIME = serverSettings.getProperty("LoginFailTime", 600) * 1000L;
        LOGIN_FAIL_BURST = serverSettings.getProperty("LoginFailBurst", 10);
