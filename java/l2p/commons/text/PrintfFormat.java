 ...
 * <pre> % ['-+ #0]* [0..9]* { . [0..9]* }+
 *                { [hlL] }+ [idfgGoxXeEcs]
 * </pre> There are variants of this basic form that are discussed below.</p>
 * <p>
 ...
 * <code>n</code>th argument after the format in the argument list, rather than
 * to the next unused argument. In this case, the conversion characer % is
 ...
 * <code>n</code>$ form of conversion specifications, each argument in the
 ...
 * column before the current position, unless the current position is the start
 * of a line.
 * </td></tr>
 * <tr><td>\f</td><td>form-feed</td><td>Moves the printing position to the
 * initial printing position of the next logical page.
 * </td></tr>
 * <tr><td>\n</td><td>newline</td><td>Moves the printing position to the start
 * of the next line.
 * </td></tr>
 * <tr><td>\r</td><td>carriage-return</td><td>Moves the printing position to the
 * start of the current line.
 * </td></tr>
 * <tr><td>\t</td><td>tab</td><td>Moves the printing position to the next
 * implementation- defined horizontal tab position.
 * </td></tr>
 * <tr><td>\v</td><td>vertical-tab</td><td>Moves the printing position to the
 * start of the next implementation-defined vertical tab position.
 * </td></tr>
 * </table></p>
 ...
 * minimum number of characters to be printed.</p>
 * <p>
 ...
 * character applies to a type long argument.</p>
 * <p>
 ...
 * width argument is taken as a - flag, followed by a positive field width.</p>
 * <p>
 * In format strings containing the %
 * <code>n</code>$ form of a conversion specification, a field width or
 ...
 * <code>n</code>$ and
 * *<code>m</code>$), or unnumbered argument specifications (that is % and *),
 * but normally not both. The only exception to this is that %% can be mixed
 * with the %
 * <code>n</code>$ form. The results of mixing numbered and unnumbered argument
 ...
 * <dl>
 * <dt>'<dd> integer portion of the result of a decimal conversion (%i, %d, %f,
 * %g, or %G) will be formatted with thousands' grouping characters. For other
 * conversions the flag is ignored. The non-monetary grouping character is used.
 * <dt>-<dd> result of the conversion is left-justified within the field. (It
 * will be right-justified if this flag is not specified).</td></tr>
 * <dt>+<dd> result of a signed conversion always begins with a sign (+ or -).
 * (It will begin with a sign only when a negative value is converted if this
 * flag is not specified.)
 * <dt>&lt;space&gt;<dd> If the first character of a signed conversion is not a
 * sign, a space character will be placed before the result. This means that if
 * the space character and + flags both appear, the space flag will be ignored.
 * <dt>#<dd> value is to be converted to an alternative form. For c, d, i, and s
 ...
 * normally are.
 * <dt>0<dd> d, i, o, x, X, e, E, f, g, and G conversions, leading zeros
 ...
 * flag is ignored. For d, i, o, x, and X conversions, if a precision is
 * specified, the 0 flag will be ignored. For c conversions, the flag is
 * ignored.
 * </dl>
 *
 ...
 * Usually, an unchecked exception will be thrown. If the format is exhausted
 * while arguments remain, the excess arguments are ignored.</p>
 *
 * <p>
 * The conversion characters and their meanings are:
 * </p>
 * <dl>
 * <dt>d,i<dd>The int argument is converted to a signed decimal in the style
 ...
 * <dt>o<dd> The int argument is converted to unsigned octal format in the style
 ...
 * <dt>x<dd> The int argument is converted to unsigned hexadecimal format in the
 ...
 * characters.
 * <dt>X<dd> Behaves the same as the x conversion character except that letters
 * ABCDEF are used instead of abcdef.
 * <dt>f<dd> The floating point number argument is written in decimal notation
 * in the style [-]ddd.ddd, where the number of digits after the radix character
 * (shown here as a decimal point) is equal to the precision specification. A
 * Locale is used to determine the radix character to use in this format. If the
 * precision is omitted from the argument, six digits are written after the
 * radix character; if the precision is explicitly 0 and the # flag is not
 * specified, no radix character appears. If a radix character appears, at least
 * 1 digit appears before it. The value is rounded to the appropriate number of
 * digits.
 * <dt>e,E<dd>The floating point number argument is written in the style
 ...
 * <dt>g,G<dd>The floating point number argument is written in style f or e (or
 * in sytle E in the case of a G conversion character), with the precision
 ...
 * <dt>c,C<dd>The integer argument is converted to a char and the result is
 * written.
 *
 * <dt>s,S<dd>The argument is taken to be a string and bytes from the string are
 ...
 * imply conversion to a long long double. </p>
 * <p>
 ...
 * precisions %n$ and *m$ Bug fixes g format fix (2 digits in e form corrupt)
 * rounding in f format implemented round up when digit not printed is 5
...
public class PrintfFormat {
     ...
     * <code>start</code> and ending at either the end of the String
     * <code>s</code>, the next unpaired percent sign, or at the end of the
     * String if the last character is a percent sign.
     *
    ...
    private class ConversionSpecification {
         ...
         * the lel2p. '+' character means that the conversion will always begin
         ...
         * left justified within the field. The default is to pad with blanks on
         * the lel2p. A '+' character means that the conversion will always
         ...
         *
         * @param sx the String to format, the result of converting a short,
         ...
         * left justified within the field. The default is to pad with blanks on
         * the lel2p. The '#' flag character means to lead with '0x'.
         *
         * The field width is treated as the minimum number of characters to be
         * printed. The default is to add no padding. Padding is with blanks by
         * default.
         ...
         * left justified within the field. The default is to pad with blanks on
         * the lel2p. The '#' flag character means that the output begins with a
         ...
         * default is to pad with blanks on the lel2p.
         *
         * The field width is treated as the minimum number of characters to be
