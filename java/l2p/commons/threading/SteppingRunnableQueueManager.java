...
public abstract class SteppingRunnableQueueManager implements Runnable {
     ...
     * @return SteppingScheduledFuture управляющий объект, отвечающий за
     * выполенение задачи
     */
    ...
    /**
     * Запланировать выполнение задачи через равные промежутки времени, с
     * начальной задержкой
     *
     * @param r задача для выполнения
    ...
    /**
     * Выбираем "степпинг" для работы задачи: если delay меньше шага выполнения,
     * результат будет равен 1 если delay больше шага выполнения, результат
