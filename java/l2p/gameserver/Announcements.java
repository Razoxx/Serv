...
public class Announcements {
    ...
    public void loadAnnouncements() {
        ...
        try {
            List<String> lines = Arrays.asList(FileUtils.readFileToString(new File("config/txt/announcements.txt"), "UTF-8").split("\n"));
            ...
            _log.error("Error while loading config/txt/announcements.txt!");
        }
    }
     ...
     *
     * @param address адрес в
     * {@link l2p.gameserver.network.l2.components.CustomMessage}
     * @param replacements массив String-ов которые атоматически добавятся в
     * сообщения
     */
