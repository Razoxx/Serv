...
public enum Stats {
    ...
    FALL("fall"),
    EXP_LOST("expLost"),
    BLEED_RESIST("bleedResist", Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY, 1.0),
    POISON_RESIST("poisonResist", Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY, 1.0),
    STUN_RESIST("stunResist", Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY, 1.0),
    ROOT_RESIST("rootResist", Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY, 1.0),
    MENTAL_RESIST("mentalResist", Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY, 1.0),
    SLEEP_RESIST("sleepResist", Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY, 1.0),
    PARALYZE_RESIST("paralyzeResist", Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY, 1.0),
    CANCEL_RESIST("cancelResist", -200., 300.),
    DEBUFF_RESIST("debuffResist", Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY, 1.0),
    MAGIC_RESIST("magicResist", -200., 300.),
    BLEED_POWER("bleedPower", -200., Double.POSITIVE_INFINITY, 1.0),
    POISON_POWER("poisonPower", -200., Double.POSITIVE_INFINITY, 1.0),
    STUN_POWER("stunPower", -200., Double.POSITIVE_INFINITY, 1.0),
    ROOT_POWER("rootPower", -200., Double.POSITIVE_INFINITY, 1.0),
    MENTAL_POWER("mentalPower", -200., Double.POSITIVE_INFINITY, 1.0),
    SLEEP_POWER("sleepPower", -200., Double.POSITIVE_INFINITY, 1.0),
    PARALYZE_POWER("paralyzePower", -200., Double.POSITIVE_INFINITY, 1.0),
    CANCEL_POWER("cancelPower", -200., Double.POSITIVE_INFINITY, 1.0),
    ...
    HEAL_EFFECTIVNESS("hpEff", 0., Config.HEAL_EFFECTIVNESS),
    MANAHEAL_EFFECTIVNESS("mpEff", -1000., Config.MANAHEAL_EFFECTIVNESS),
    CPHEAL_EFFECTIVNESS("cpEff", 0., Config.CPHEAL_EFFECTIVNESS),
    HEAL_POWER("healPower", 0., Config.HEAL_POWER),
