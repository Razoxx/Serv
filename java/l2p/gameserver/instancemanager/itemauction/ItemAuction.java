...
public class ItemAuction {
    ...
    private boolean reduceItemCount(Player player, long count) {
        ...
        return ItemFunctions.deleteItem(player, Config.ALT_ITEM_AUCTION_BID_ITEM_ID, count);
    }

    private void increaseItemCount(Player player, long count) {
        ItemFunctions.addItem(player, Config.ALT_ITEM_AUCTION_BID_ITEM_ID, count);
    }

    /**
     * Returns the last bid for the given player or -1 if he did not made one
     * yet.
     *
