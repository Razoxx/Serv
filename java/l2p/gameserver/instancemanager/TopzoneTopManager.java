 ...
 * @author user
 */
public class TopzoneTopManager {
                ...
                for (Player player : GameObjectsStorage.getAllPlayers()) {
                    ...
                    if (canReward) {
                        for (int i : Config.TOPZONE_BIG_REWARD.keySet()) {
                            player.getInventory().addItem(i, Config.TOPZONE_BIG_REWARD.get(i));
                        }
                    } else {
                ...
                for (Player player : GameObjectsStorage.getAllPlayers()) {
                    ...
                    if (canReward) {
                        for (int i : Config.TOPZONE_SMALL_REWARD.keySet()) {
                            player.getInventory().addItem(i, Config.TOPZONE_SMALL_REWARD.get(i));
                        }
                    } else {
                        player.sendMessage("Already " + Config.TOPZONE_DUALBOXES_ALLOWED + " character(s) of your ip have been rewarded, so this character won't be rewarded.");
                    }
