...
import l2p.gameserver.serverpackets.ExCubeGameChangeTeam;
...
public final class HandysBlockCheckerManager {
    ...
    /**
     * Add the player to the specified arena (throught the specified arena
     * manager) and send the needed server -> client packets
     *
     * @param player
     * @param arenaId
     */
    ...
    /**
     * Will remove the specified player from the specified team and arena and
     * will send the needed packet to all his team mates / enemy team mates
     *
     * @param player
     * @param arenaId
     */
    ...
    /**
     * Will change the player from one team to other (if possible) and will send
     * the needed packets
     *
     * @param player
     * @param arena
