...
import l2p.gameserver.network.telnet.commands.TelnetBan;
import l2p.gameserver.network.telnet.commands.TelnetConfig;
import l2p.gameserver.network.telnet.commands.TelnetDebug;
import l2p.gameserver.network.telnet.commands.TelnetItems;
import l2p.gameserver.network.telnet.commands.TelnetPerfomance;
import l2p.gameserver.network.telnet.commands.TelnetSay;
import l2p.gameserver.network.telnet.commands.TelnetServer;
import l2p.gameserver.network.telnet.commands.TelnetStatus;
import l2p.gameserver.network.telnet.commands.TelnetWorld;
...
public class TelnetServerHandler extends SimpleChannelUpstreamHandler implements TelnetCommandHolder {
    ...
    public void channelConnected(ChannelHandlerContext ctx, ChannelStateEvent e) throws Exception {
        ...
        e.getChannel().write("Welcome to L2-FT GameServer telnet console.\n\r");
