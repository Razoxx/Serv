...
public class Util {
    ...
    /**
     * Инструмент для подсчета выпавших вещей с учетом рейтов. Возвращает 0 если
     * шанс не прошел, либо количество если прошел. Корректно обрабатывает шансы
     * превышающие 100%. Шанс в 1:1000000 (Drop.MAX_CHANCE)
     */
    ...
    public static String getServerKey() throws Exception {
        return "Moraxus.ru r1509 (stable)";
    }
