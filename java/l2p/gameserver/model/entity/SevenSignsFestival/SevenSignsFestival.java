...
public class SevenSignsFestival {
     ...
     * table and should be treated as such. Data is initially accessed by the
     * related Seven Signs cycle, with _signsCycle representing data for the
     * current round of Festivals. The actual table data is stored as a series
     * of StatsSet constructs. These are accessed by the use of an offset based
     * on the number of festivals, thus: offset = FESTIVAL_COUNT + festivalId
    ...
    /**
     * If a clan member is a member of the highest-ranked party in the Festival
     * of Darkness, 100 points are added per member
     */
