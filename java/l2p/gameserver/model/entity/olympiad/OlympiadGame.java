...
import l2p.gameserver.utils.PlayerUtils;
    ...
    public void tie() {
        ...
        for (int i = 0; i < teamMembers1.length; i++) {
            try {
                ...
                for (Effect e : member1.getPlayer().getEffectList().getAllEffects()) {
                    if (!e.getSkill().isToggle()) {
                        e.exit();
                    }
                }
                for (Effect e : member2.getPlayer().getEffectList().getAllEffects()) {
                    if (!e.getSkill().isToggle()) {
                        e.exit();
                    }
                }
                if (member1.getPlayer().getPet() != null) {
                    member1.getPlayer().getPet().getEffectList().stopAllEffects();
                }
                if (member2.getPlayer().getPet() != null) {
                    member2.getPlayer().getPet().getEffectList().stopAllEffects();
                }
