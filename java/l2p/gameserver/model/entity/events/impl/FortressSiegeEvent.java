...
public class FortressSiegeEvent extends SiegeEvent<Fortress, SiegeClanObject> {
    ...
    public class KillListener implements OnKillListener {
        ...
        public void onKill(Creature actor, Creature victim) {
            ...
            if (/*SiegeEvent.this instanceof FortressSiegeEvent ||*/winner == null || !victim.isPlayer() || winner.getLevel() < 40 || winner == victim || victim.getEvent(FortressSiegeEvent.this.getClass()) != FortressSiegeEvent.this || !checkIfInZone(actor) || !checkIfInZone(victim)) {
                return;
            }

            winner.setFame(winner.getFame() + Rnd.get(Config.RATE_SIEGE_FAME.get(0), Config.RATE_SIEGE_FAME.get(1)), FortressSiegeEvent.this.toString());
        }
    ...
    public SystemMsg checkForAttack(Creature target, Creature attacker, Skill skill, boolean force) {
        try {
            ...
            //if(!targetPlayer.isOnSiegeField() && !attackerPlayer.isOnSiegeField())
            //	return null;
