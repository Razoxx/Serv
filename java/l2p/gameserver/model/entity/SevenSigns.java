...
public class SevenSigns {
    ...
    public static final int SEAL_STONE_BLUE_VALUE = (int)(3 * Config.RATE_DROP_BLUE_STONE);
    public static final int SEAL_STONE_GREEN_VALUE = (int)(5 * Config.RATE_DROP_GREEN_STONE);
    public static final int SEAL_STONE_RED_VALUE = (int)(10 * Config.RATE_DROP_RED_STONE);
    ...
    /**
     * Сохраняет всю информацию о печатях, как для игроков, так и глобальные
     * переменные.
     *
     * @param playerId — если больше нуля то сохранение личных параметров
     * производится только для одного игрока, иначе для всех
     * @param updateSettings — если true сохраняет глобальные параметры, иначе
     * только личные
     */
