...
import static l2p.gameserver.model.base.ClassLevel.First;
import static l2p.gameserver.model.base.ClassLevel.Fourth;
import static l2p.gameserver.model.base.ClassLevel.Second;
import static l2p.gameserver.model.base.ClassLevel.Third;
import static l2p.gameserver.model.base.ClassType.Fighter;
import static l2p.gameserver.model.base.ClassType.Mystic;
import static l2p.gameserver.model.base.ClassType.Priest;
import static l2p.gameserver.model.base.Race.darkelf;
import static l2p.gameserver.model.base.Race.dwarf;
import static l2p.gameserver.model.base.Race.elf;
import static l2p.gameserver.model.base.Race.human;
import static l2p.gameserver.model.base.Race.kamael;
import static l2p.gameserver.model.base.Race.orc;
...
public enum PlayerClass {
    ...
    public final Set<PlayerClass> getAvailableSubclasses() {
        ...
        if (_race == Race.kamael && !Config.ALT_SUB_ALL_CHANGE) {
