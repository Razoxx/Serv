...
public abstract class Inventory extends ItemContainer {
    ...
    public void onPaperdollItemId(int slot, int itemId) {
        ItemInstance item = getPaperdollItem(slot);
        if (item != null) {
            if (item.isEquipped()) {
                unEquipItem(item);
                item.setFakeItemId(itemId);
                equipItem(item);
            }
        }
    }
    ...
    public int getPaperdollItemId(int slot) {
        ...
        ItemInstance item = getPaperdollItem(slot);
        if (item != null) {
            if (getPaperdollItem(PAPERDOLL_CHEST) != null && !Config.ALLOW_VISUAL_FROM_AUGMENT) {
                if (getPaperdollItem(PAPERDOLL_CHEST).isVisualItem()) {
                    switch (slot) {
                        case PAPERDOLL_CHEST:
                            return (VisualConfig.getVisualConfigId(getPaperdollItem(PAPERDOLL_CHEST).getVisualItemId()).chestId != 0 ? VisualConfig.getVisualConfigId(getPaperdollItem(PAPERDOLL_CHEST).getVisualItemId()).chestId : VisualConfig.getVisualConfigId(getPaperdollItem(PAPERDOLL_CHEST).getVisualItemId()).fullBodyId);
                        case PAPERDOLL_LEGS:
                            return (VisualConfig.getVisualConfigId(getPaperdollItem(PAPERDOLL_CHEST).getVisualItemId()).leggingsId);

                        case PAPERDOLL_FEET:
                            return (VisualConfig.getVisualConfigId(getPaperdollItem(PAPERDOLL_CHEST).getVisualItemId()).bootsId);
                        case PAPERDOLL_GLOVES:
                            return (VisualConfig.getVisualConfigId(getPaperdollItem(PAPERDOLL_CHEST).getVisualItemId()).glovesId);
                    }
                }
            ...
            if (getPaperdollItem(PAPERDOLL_CHEST) != null && Config.ALLOW_VISUAL_FROM_AUGMENT) {
                ...
                } else if (getPaperdollItem(PAPERDOLL_CHEST).isFakeItem()) {
                    switch (slot) {
                        case PAPERDOLL_CHEST:
                            return item.getFakeItemId();
                        case PAPERDOLL_LEGS:
                            return 0;
            ...
            if (!Config.ALLOW_VISUAL_FROM_AUGMENT) {
                if (getPaperdollItem(PAPERDOLL_RHAND) != null) {
                    if (getPaperdollItem(PAPERDOLL_RHAND).isVisualItem()) {
                        switch (slot) {
                            case PAPERDOLL_RHAND:
                                return (VisualConfig.getVisualConfigId(getPaperdollItem(PAPERDOLL_RHAND).getVisualItemId()).weaponId);
                        }
                    }

                } else if (getPaperdollItem(PAPERDOLL_LHAND) != null) {
                    if (getPaperdollItem(PAPERDOLL_LHAND).isVisualItem()) {
                        switch (slot) {
                            case PAPERDOLL_LHAND:
                                return (VisualConfig.getVisualConfigId(getPaperdollItem(PAPERDOLL_LHAND).getVisualItemId()).weaponId);
                        }
                    }
                ...
                if (getPaperdollItem(PAPERDOLL_RHAND) != null) {
                    ...
                    } else if (getPaperdollItem(PAPERDOLL_RHAND).isFakeItem()) {
                        switch (slot) {
                            case PAPERDOLL_RHAND:
                                return item.getFakeItemId();
                        }
            ...
            if (getPaperdollItem(PAPERDOLL_CHEST) != null && !Config.ALLOW_VISUAL_FROM_AUGMENT) {
                if (getPaperdollItem(PAPERDOLL_CHEST).getVisualItemId() != 0) {
                    if (VisualConfig.getVisualConfigId(getPaperdollItem(PAPERDOLL_CHEST).getVisualItemId()).helmetId != 0) {
                        return (VisualConfig.getVisualConfigId(getPaperdollItem(PAPERDOLL_CHEST).getVisualItemId()).helmetId);
                    }
                }
            }
