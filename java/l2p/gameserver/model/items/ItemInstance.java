...
public final class ItemInstance extends GameObject implements JdbcEntity {
    ...
    public void setVisualItemId(int val) {
        _visualId = val;
    }
    ...
    public int getFakeItemId() {
        return _fakeId;
    }

    public void setFakeItemId(int val) {
        _fakeId = val;
    }
    ...
    public boolean canBeTraded(Player player) {
        ...
        if (!template.isStoreable() && player.hasBonus() ? PremiumConfig.getPremConfigId(player.getBonus().getBonusId()).ALLOW_TRANSFER_ITEM : false) {
            return true;
        }
