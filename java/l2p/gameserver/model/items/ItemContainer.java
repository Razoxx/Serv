...
public abstract class ItemContainer {
    ...
    /**
     * Создать вещь и добавить в список, либо увеличить количество вещи в
     * инвентаре
     *
    ...
    public ItemInstance addItem(int itemId, long count, int enchant) {
        if (count < 1) {
            return null;
        }
     ...
     * При добавлении нескольких вещей подряд, список должен быть заблокирован с
     * writeLock() и разблокирован после добавления с writeUnlock()<br>
     * <br>
     * <b><font color="red">Должно выполнятся в блоке
     * synchronized(item)</font></b>
     *
     ...
     * @param count - на какое количество уменьшить, если количество равно
     * количество вещи, то вещь удаляется из списка
    ...
    /**
     * Удаляет вещь из списка, либо уменьшает количество первой найденной вещи
     * по itemId
     *
     ...
     * При удалении нескольких вещей подряд, список должен быть заблокирован с
     * writeLock() и разблокирован после добавления с writeUnlock()<br>
     * <br>
     * <b><font color="red">Должно выполнятся в блоке
     * synchronized(item)</font></b>
    ...
    /**
     * Уничтожить вещь из списка, либо снизить количество по идентификатору
     * objectId
     *
     * @param objectId
