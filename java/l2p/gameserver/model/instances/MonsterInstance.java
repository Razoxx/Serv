...
public class MonsterInstance extends NpcInstance {
    ...
    /**
     * The table containing all players objectID that successfully absorbed the
     * soul of this L2NpcInstance
     */
    ...
    public TeamType getTeam() {
        return getChampion() == 2 ? Config.ChampionRedAuraEnabled ? TeamType.RED : TeamType.NONE : getChampion() == 1 ? Config.ChampionBlueAuraEnabled ? TeamType.BLUE : TeamType.NONE : TeamType.NONE;
    }
