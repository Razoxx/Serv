...
public final class TamedBeastInstance extends FeedableBeastInstance {
    ...
    static {
        ...
        TAMED_DATA[1] = new AbstractMap.SimpleImmutableEntry<NpcString, int[]>(NpcString.S1_OF_BALANCE, new int[]{6431, 6666});
        TAMED_DATA[2] = new AbstractMap.SimpleImmutableEntry<NpcString, int[]>(NpcString.SHARP_S1, new int[]{6432, 6668});
        TAMED_DATA[3] = new AbstractMap.SimpleImmutableEntry<NpcString, int[]>(NpcString.USEFUL_S1, new int[]{6433, 6670});
        TAMED_DATA[4] = new AbstractMap.SimpleImmutableEntry<NpcString, int[]>(NpcString.S1_OF_BLESSING, new int[]{6669, 6672});
        TAMED_DATA[5] = new AbstractMap.SimpleImmutableEntry<NpcString, int[]>(NpcString.SWIFT_S1, new int[]{6434, 6667});
    }
