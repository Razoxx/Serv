...
public final class PetBabyInstance extends PetInstance {
    ...
    private static final Skill[][] WHITE_WEASEL_BUFFS = {
        {SkillTable.getInstance().getInfo(Pet_Might, 3), SkillTable.getInstance().getInfo(Pet_Haste, 2),
            SkillTable.getInstance().getInfo(Pet_Focus, 3), SkillTable.getInstance().getInfo(Pet_Wind_Walk, 2),
            SkillTable.getInstance().getInfo(Pet_Blessed_Body, 6), SkillTable.getInstance().getInfo(Pet_Shield, 3),
            SkillTable.getInstance().getInfo(Pet_Death_Wisper, 3), SkillTable.getInstance().getInfo(Pet_Vampiric_Rage, 4)},
        {SkillTable.getInstance().getInfo(Pet_Might, 3), SkillTable.getInstance().getInfo(Pet_Haste, 2),
            SkillTable.getInstance().getInfo(Pet_Focus, 3), SkillTable.getInstance().getInfo(Pet_Wind_Walk, 2),
            SkillTable.getInstance().getInfo(Pet_Blessed_Body, 6), SkillTable.getInstance().getInfo(Pet_Shield, 3),
            SkillTable.getInstance().getInfo(Pet_Death_Wisper, 3), SkillTable.getInstance().getInfo(Pet_Vampiric_Rage, 4)},
    ...
    private static final Skill[][] FAIRY_PRINCESS_BUFFS = {
        {SkillTable.getInstance().getInfo(Pet_Empower, 3), SkillTable.getInstance().getInfo(Pet_Blessed_Soul, 6),
            SkillTable.getInstance().getInfo(Pet_Wind_Walk, 2), SkillTable.getInstance().getInfo(Pet_Shield, 3),
    ...
    private static final Skill[][] TURTLE_ASCETIC_BUFFS = {
        {SkillTable.getInstance().getInfo(Pet_Blessed_Soul, 6), SkillTable.getInstance().getInfo(Pet_Wind_Walk, 2),
            SkillTable.getInstance().getInfo(Pet_Blessed_Body, 6), SkillTable.getInstance().getInfo(Pet_Shield, 3),
            SkillTable.getInstance().getInfo(Armor_Maintenance, 1), SkillTable.getInstance().getInfo(Weapon_Maintenance, 1)},
        {SkillTable.getInstance().getInfo(Pet_Blessed_Soul, 6), SkillTable.getInstance().getInfo(Pet_Wind_Walk, 2),
            SkillTable.getInstance().getInfo(Pet_Blessed_Body, 6), SkillTable.getInstance().getInfo(Pet_Shield, 3),
            SkillTable.getInstance().getInfo(Armor_Maintenance, 1), SkillTable.getInstance().getInfo(Weapon_Maintenance, 1)},
        {SkillTable.getInstance().getInfo(Pet_Blessed_Soul, 6), SkillTable.getInstance().getInfo(Pet_Wind_Walk, 2),
    ...
    private static final Skill[][] ROSE_REKANG_BUFFS = {
        ...
        {SkillTable.getInstance().getInfo(Pet_Blessed_Body, 6), SkillTable.getInstance().getInfo(Pet_Wind_Walk, 2),
            SkillTable.getInstance().getInfo(Pet_Blessed_Soul, 6), SkillTable.getInstance().getInfo(Pet_Shield, 3)},
        {SkillTable.getInstance().getInfo(Pet_Blessed_Body, 6), SkillTable.getInstance().getInfo(Pet_Wind_Walk, 2),
            SkillTable.getInstance().getInfo(Pet_Blessed_Soul, 6), SkillTable.getInstance().getInfo(Pet_Shield, 3),
    ...
    private static final Skill[][] IMPROVED_ROSE_DESELOPH_BUFFS = {
        ...
        {SkillTable.getInstance().getInfo(Improved_Condition, 1),
            SkillTable.getInstance().getInfo(Improved_Movement, 1), SkillTable.getInstance().getInfo(Improved_Combat, 1),
    ...
    private static final Skill[][] IMPROVED_ROSE_HYUM_BUFFS = {
        ...
        {SkillTable.getInstance().getInfo(Pet_Acumen, 3), SkillTable.getInstance().getInfo(Improved_Condition, 1),
            SkillTable.getInstance().getInfo(Improved_Combat, 1), SkillTable.getInstance().getInfo(Improved_Movement, 1),},
        {SkillTable.getInstance().getInfo(Pet_Acumen, 3), SkillTable.getInstance().getInfo(Improved_Condition, 1),
            SkillTable.getInstance().getInfo(Improved_Combat, 1), SkillTable.getInstance().getInfo(Improved_Movement, 1),
