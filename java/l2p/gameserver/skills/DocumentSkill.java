...
public final class DocumentSkill extends DocumentBase {
    ...
    public class Skill {
        ...
        public List<l2p.gameserver.model.Skill> skills = new ArrayList<l2p.gameserver.model.Skill>();
        public List<l2p.gameserver.model.Skill> currentSkills = new ArrayList<l2p.gameserver.model.Skill>();
    }
    private Skill currentSkill;
    private Set<String> usedTables = new HashSet<String>();
    private List<l2p.gameserver.model.Skill> skillsInFile = new LinkedList<l2p.gameserver.model.Skill>();
    ...
    protected List<l2p.gameserver.model.Skill> getSkills() {
        return skillsInFile;
    }
    ...
    protected void parseSkill(Node n) {
        ...
        try {
            ...
            for (int i = 0; i < lastLvl; i++) {
                ...
                l2p.gameserver.model.Skill current = currentSkill.currentSkills.get(i);
    ...
    private void makeSkills() {
        currentSkill.currentSkills = new ArrayList<l2p.gameserver.model.Skill>(currentSkill.sets.length);
