...
public abstract class ExReceiveOlympiad extends L2GameServerPacket {
    ...
    public static class MatchResult extends ExReceiveOlympiad {
        ...
        public void addPlayer(int team, TeamMember member, int gameResultPoints) {
            ...
            PlayerInfo playerInfo = new PlayerInfo(member.getName(), member.getClanName(), member.getClanId(), member.getClassId(), points, gameResultPoints, (int) member.getDamage());
        ...
        private static class PlayerInfo {
            ...
            private int _clanId, _classId, _currentPoints, _gamePoints, _damage;
