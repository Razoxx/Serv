...
public class StatusUpdate extends L2GameServerPacket {
    ...
    /**
     * Даный параметр отсылается оффом в паре с MAX_HP Сначала CUR_HP, потом
     * MAX_HP
     */
    public final static int CUR_HP = 0x09;
    public final static int MAX_HP = 0x0a;
    /**
     * Даный параметр отсылается оффом в паре с MAX_MP Сначала CUR_MP, потом
     * MAX_MP
     */
    ...
    /**
     * Даный параметр отсылается оффом в паре с MAX_CP Сначала CUR_CP, потом
     * MAX_CP
     */
