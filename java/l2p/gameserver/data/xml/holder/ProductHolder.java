                        ...
                        if ("product".equalsIgnoreCase(d1.getNodeName())) {
                            ...
                            for (Node t1 = d1.getFirstChild(); t1 != null; t1 = t1.getNextSibling()) {
                                if ("component".equalsIgnoreCase(t1.getNodeName())) {
                                    ...
                                    int enchant = 0;
                                    if (t1.getAttributes().getNamedItem("enchant") != null) {
                                        enchant = Integer.parseInt(t1.getAttributes().getNamedItem("enchant").getNodeValue());
                                    }
                                    ProductItemComponent component = new ProductItemComponent(item_id, count, enchant);
