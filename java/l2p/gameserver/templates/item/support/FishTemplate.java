...
public class FishTemplate {
    ...
    private final IntObjectMap<RewardData> _rewards = new HashIntObjectMap<RewardData>();
    ...
    public FishTemplate(MultiValueSet<String> map, List<MultiValueSet<String>> rewards) {
        ...
        for (MultiValueSet<String> reward : rewards) {
            ...
            _rewards.put(id, new RewardData(id, mindrop, maxdrop, chance));
        }
    }
    ...
    public Collection<RewardData> getRewards() {
