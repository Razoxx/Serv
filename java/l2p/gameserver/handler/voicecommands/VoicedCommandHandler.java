...
import l2p.gameserver.handler.voicecommands.impl.CWHPrivileges;
...
import l2p.gameserver.handler.voicecommands.impl.Inform;
import l2p.gameserver.handler.voicecommands.impl.Offline;
import l2p.gameserver.handler.voicecommands.impl.Password;
import l2p.gameserver.handler.voicecommands.impl.Relocate;
