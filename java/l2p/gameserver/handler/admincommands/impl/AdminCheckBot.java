...
public class AdminCheckBot implements IAdminCommandHandler {
    ...
    private static void sendBotPage(Player activeChar) {
        ...
        HtmlMessage nhm = new HtmlMessage(5);
    ...
    /**
     * Will introduce the first time a new punished bot in database, to avoid
     * problems on his punish time left update, as will remove his reports from
     * database
     *
     * @param Player
     */
