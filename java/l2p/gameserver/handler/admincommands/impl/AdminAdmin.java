        ...
        if (activeChar.getPlayerAccess().Menu) {
            switch (command) {
                ...
                case admin_undying:
                    ...
                    break;
                    case admin_ref:
                        activeChar.sendMessage("Reflection = "+ activeChar.getReflection().getId());
                        activeChar.sendMessage("Reflection InstancedZone = "+ activeChar.getReflection().getInstancedZoneId());
                    break;
            }
            return true;
        }
