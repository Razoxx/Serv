...
/**
 * changelvl - Изменение уровня доступа moders - Панель управления модераторами
 * moders_add - Добавление модератора moders_del - Удаление модератора penalty -
 * Штраф за некорректное модерирование
 */
