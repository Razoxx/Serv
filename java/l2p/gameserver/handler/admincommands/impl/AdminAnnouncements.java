    ...
    public boolean useAdminCommand(Enum comm, String[] wordList, String fullString, Player activeChar) {
        ...
        switch (command) {
            ...
            case admin_s_new:
                ...
                int time1 = 100 + text1.length() * 100; // 3 секунды + 100мс на символ
                ExShowScreenMessage sm1 = new ExShowScreenMessage(text1 + " icon.skill0000", 500, ScreenMessageAlign.TOP_CENTER, text1.length() < 64);
                for (Player player : GameObjectsStorage.getAllPlayersForIterate()) {
